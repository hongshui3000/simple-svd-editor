...
import { columnsForTable, makeData } from '@scripts/mock';
...
<Meta
    ...
    component={Table}
    parameters={{ backgrounds: { default: 'grey200' }, paddings: { default: 'Nonne' } }}
/>
...
<Canvas>
    <Story name="TableHeader">
        <TableHeader>
            ...
            <Button theme="fill" Icon={ResetIcon} css={{ marginLeft: scale(2) }} onClick={action('onResetClick')}>
                Сбросить
            </Button>
...
<Canvas>
    <Story name="TableFooter">
        <TableFooter pages={7} itemsPerPageCount={10} setItemsPerPageCount={action('onSetItemsPerPageCount')} />
    </Story>
</Canvas>
